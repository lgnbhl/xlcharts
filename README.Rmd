...
FULL DOCUMENTATION: <a href="https://felixluginbuhl.com/xlcharts">www.felixluginbuhl.com/xlcharts</a>
...
As **xlcharts** is using the [OpenPyXL](https://openpyxl.readthedocs.io)
Python library under the hood, you might have to install it manually.
